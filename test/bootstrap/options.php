...
else
{
  ...
  function kNewsPlugin_cli_cleanup()
  {
    unlink(OPTIONS_FILE);
  }

  register_shutdown_function('kNewsPlugin_cli_cleanup');
}
...
if (empty($_SERVER['kNewsPlugin_DEPENDANCIES']))
{
  $_SERVER['kNewsPlugin_DEPENDANCIES'] = $options['dependancies'];
}